...
- My Go journey
  - Started just playing around with it out of interest
  - Used it for Advent of Code 2024
  - Joined the ARC TRE team
...
- Fast build times & cross-compilation
  - Cross-compile for all platforms: `GOOS=linux GOARCH=amd64 go build`
- Small static binaries
  - Binary size: ~15MB for a full-featured CLI tool
- Low memory footprint and garbage collection
  - Memory: typical Go service uses 10-50MB vs. 100-500MB for JVM
