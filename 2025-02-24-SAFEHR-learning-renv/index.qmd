...
![](./figures/it-works-on-my-machine.png){fig-align="center" fig-alt="It works on my machine meme"}
:::
...
![](./figures/renv-folder-structure.png){fig-align="center" fig-alt="Project Structure with renv"}
...
*Only do this when you have a compelling reason to do so*
...
- **RESTART, RESTART, RESTART**
    - Get in the habit of regularly restarting your *R session*
    - Learn those [keyboard shortcuts](https://docs.posit.co/ide/user/ide/reference/shortcuts.html)!
- Although the regular install commands (`install.packages()`, `remotes::install_github()`) should work with `renv`,
  use `renv::install()` just to be sure
