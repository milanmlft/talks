...
::: {style="font-size: 60%;"}
-- [Zen And The aRt Of Workflow Maintenance - Jenny Bryan][bryan-zen-37]
:::
...
![](figures/debugging.jpg){fig-align="center" fig-alt="What debugging feels like"}

## Code formatting

![](figures/code-formatting-meme.png){width=50% fig-align="center" fig-alt="Code formatting meme"}
...
::: {.nonincremental}
* [*R Packages*][r-pkgs] by Hadley Wickham and Jenny Bryan – *The Golden Standard*
* [*What They Forgot to Teach You About R*][wtf-r] by Jenny Bryan


<br>

* [*Tidyverse style guide*][tidyverse-style]
* [*“Better packages”*][better-packages] presentation by Maëlle Salmon
